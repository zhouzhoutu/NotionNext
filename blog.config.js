...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '600537e5c670409eb6a810867762dbf3,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  REVALIDATION_TOKEN: process.env.REVALIDATION_TOKEN || '', // On-Demand Revalidation Token；配置后可用 /api/revalidate 主动刷新页面缓存
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion,博客,质数人生,自我成长,内容推荐,软件应用,自我提升,技术分享,生活记录,投资理财,人生感悟', // 网站关键词 英文逗号隔开
